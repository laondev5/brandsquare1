...
const handleInputChange = (e: React.ChangeEvent<HTMLInputElement >) => {
  ...
  return (
    <div>
      <div className="fixed top-28  left-1/2   transform -translate-x-1/2 md:-translate-x-0 md:left-[60%]  min-h-[80vh] md:h-[80vh]  md:w-[40vw] w-[90vw] lg:w-[30vw]  rounded-2xl   bg-white shadow-lg">
